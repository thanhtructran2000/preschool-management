			...
			<div class="col-xs-12">
				<div class="page-header">
					...
					<div class="page-header-content">
						<h2 class="page-title">Thông tin phụ huynh</h2>
						<hr class="line-color">
						<ol class="breadcrumb">
							<li><a href='trangchu'>Trang chủ</a></li>
							<li class="active"><a href="{{url('/dsphuhuynh')}}">Thông tin phụ huynh</a></li>
						</ol>						
					</div>
				</div>
			</div>
			...
			<div id="main-content" class="col-xs-40 col-md-12">
				<div class="box-item">
					...
					<div class="single-content">
						...
						<h1 class="single-title">Thông tin phụ huynh</h1>
                        ...
                        <!-- phan search -->
                        <form  class="archive-searchform" type ="get" action="{{url('/searchdsphuhuynh')}}" method="GET" >
